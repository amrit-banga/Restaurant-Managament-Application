...
struct VerificationView: View {
    ...
    @State private var navigateToAddBusiness = false
    var email: String
    @State private var correctCode: String = ""
    private let sendGridAPIKey = "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"
    ...
    var body: some View {
        ...
        .background(
            NavigationLink(destination: AddBusinessView(), isActive: $navigateToAddBusiness) {
                EmptyView()
            }
        )
    }
